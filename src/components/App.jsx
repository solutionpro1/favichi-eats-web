        ...
        <div className="relative z-10">
          ...
          <section className="py-16 px-6 bg-slate-900 text-white grid md:grid-cols-2 gap-12 items-center border-t border-slate-800">
            ...
            <div className="w-full h-64 bg-slate-800 rounded-2xl overflow-hidden relative shadow-md">
              <iframe title="Map" src="https://maps.google.com/maps?q=10%20Lawal%20Oladipo%20Street%20Alagbado%20Lagos&t=&z=15&ie=UTF8&iwloc=&output=embed" className="w-full h-full border-0 filter grayscale invert contrast-125 opacity-80" allowFullScreen="" loading="lazy"></iframe>
            </div>
          </section>
          <Footer />
          <FloatingSocials />
