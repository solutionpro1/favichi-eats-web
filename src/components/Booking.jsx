      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs text-slate-600 mt-2 leading-relaxed">Get a dedicated professional chef stationed at your home to manage meal preps, specialized diets, and daily family catering on weekly or monthly arrangements.</p>
          </div>
          <button onClick={() => onBooking("Chef for Residence")} className="mt-6 w-full bg-blue-600 text-white text-xs font-bold py-3 rounded-xl hover:bg-blue-700 transition flex items-center justify-center gap-2 shadow-sm">
